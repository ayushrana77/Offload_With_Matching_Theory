...
class ProposedTaskOffloadingAlgorithm:
    ...
    def initialize_system(self):
        ...
        # Ensure random seeds are set BEFORE generating any random data
    ...
    def run_matching_algorithm(self) -> Dict[str, List[str]]:
        ...
        print(f"System scale: {len(self.tasks)} total tasks")
...
def main():
    ...
    if hasattr(config, 'use_multilevel') and config.use_multilevel:
        ...
        print(f"\n✅ Hierarchical offloading: {edge_tasks + regional_tasks + cloud_tasks} tasks using fog-cloud infrastructure")
        print(f"={'='*50}")
