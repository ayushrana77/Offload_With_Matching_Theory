"""
Simple IoT Device Preferences Generator (WITHOUT Energy)
Generates preference lists for IoT devices using Simplified Formula WITHOUT Energy:
...
(Note: The original IoT preferences already don't use energy, but this is 
created for consistency and clarity)
"""
...
class SimpleIoTPreferencesGenerator:
    def __init__(self):
        """Initialize the simple IoT preferences generator"""
        self.iot_devices = []
        self.fog_devices = []
    ...
    def generate_theoretical_user_preferences(self, users: List[Dict], servers: List[Dict], 
        ...
        """
        Generate user preferences using SIMPLIFIED FORMULA WITHOUT ENERGY:
        O_j(i) = 1/(ω_j^i(ζ) + ξ_j^i)
        
        This is Formula 4 from the research paper WITHOUT energy considerations.
        ...
        print("\n=== Generating User Preferences (Simplified Formula WITHOUT Energy) ===")
        ...
        for i, user in enumerate(users):
            ...
            for j, server in enumerate(servers):
                ...
                # Apply Simplified Formula WITHOUT Energy: O_j(i) = 1/(ω_j^i(ζ) + ξ_j^i)
...
if __name__ == "__main__":
    """Example usage of the simple IoT preferences generator"""
    print("=== Simple IoT Preferences Generator (WITHOUT Energy) ===")
